<?php
// Make sure browsers + search bots see this as a real 404, not a 200.
...
<title>404 — Lost in the sakura ♡</title>
...
html, body {
    ...
    font-weight: 300;
    overflow-x: hidden;
    /* Heart cursor, matching the rest of the OverPinku theme. */
...
/* Sakura petals drifting down — pure CSS, JS just spawns them. */
.sakura-petal {
    position: fixed;
    top: -30px;
    pointer-events: none;
...
<div class="wrap">
    ...
    <div class="title">This page wandered off into the sakura ♡</div>
    <p class="subtitle">
        The path you're looking for doesn't exist — or maybe it just got lost in
        all the pink. Let's get you back home.
    </p>
...
(function () {
    ...
    // ── Click anywhere → burst of hearts (matches the rest of the OverPinku theme) ──
    var heartChars  = ['♥', '♥', '♥', '♡', '❤'];
    ...
    document.addEventListener('click', function (e) {
        ...
        // Delay same-origin link navigation so the burst stays visible,
        // matching the existing OverPinku pages.
