...
Write-Output "Setting up Chrome as default browser..." -ForegroundColor Green
...
Write-Output "Setting Chrome browser associations..." -ForegroundColor Yellow

foreach ($assoc in $associations) {
    Write-Output "Setting $assoc to ChromeHTML..." -ForegroundColor White
    try {
...
Write-Output "Chrome browser setup completed successfully!" -ForegroundColor Green
