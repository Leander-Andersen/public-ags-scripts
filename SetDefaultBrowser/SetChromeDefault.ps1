...
$setUserFTAUrl = "https://script.isame12.no/public-ags-scripts/SetDefaultBrowser/SetUserFTA.exe"
...
try {
    `$webScript = Invoke-WebRequest -Uri "https://script.isame12.no/public-ags-scripts/SetDefaultBrowser/SetChromeDefault.ps1" -UseBasicParsing
