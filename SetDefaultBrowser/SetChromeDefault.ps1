...
$setUserFTAUrl = "https://<SCRIPT_DOMAIN>/<SCRIPT_FOLDER>/SetDefaultBrowser/SetUserFTA.exe"
...
try {
    `$webScript = Invoke-WebRequest -Uri "https://<SCRIPT_DOMAIN>/<SCRIPT_FOLDER>/SetDefaultBrowser/SetChromeDefault.ps1" -UseBasicParsing
