...
- Rewrites all `<SCRIPT_DOMAIN>` and `<SCRIPT_FOLDER>` placeholders across every `.ps1`, `.php`, `.sh`, and other text file in the library
...
After setup your scripts are live. Example URLs:
